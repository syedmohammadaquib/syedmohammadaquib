...
<h1><font size="6">𝙎𝙔𝙀𝘿 𝙈𝙊𝙃𝘼𝙈𝙈𝘼𝘿 𝘼𝙌𝙐𝙄𝘽</font></h1>
...
![C](https://img.shields.io/badge/C-A8B9C4?style=for-the-badge)
...
<h2>𝑨𝑰 & 𝑰𝒏𝒕𝒆𝒈𝒓𝒂𝒕𝒊𝒐𝒏𝒔</h2>

![Gemini API](https://img.shields.io/badge/Gemini_API-4285F4?style=for-the-badge&logo=googlegemini&logoColor=white)
![Grok API](https://img.shields.io/badge/Grok_API-000000?style=for-the-badge&logo=x&logoColor=white)
![Cloudinary](https://img.shields.io/badge/Cloudinary-3448C5?style=for-the-badge&logo=cloudinary&logoColor=white)

<br>

<h2>𝑻𝒐𝒐𝒍𝒔 & 𝑷𝒍𝒂𝒕𝒇𝒐𝒓𝒎𝒔</h2>
...
An **AI-powered interview platform** designed to streamline the interview process for recruiters and provide structured, intelligent candidate evaluation.

**Highlights**

- Built a complete platform for **creating and scheduling interviews**
- Enables recruiters to **invite candidates and manage interview workflows**
- Provides structured candidate response and performance analysis
- Integrated a dedicated **Python-based AI service** for automated evaluation
- Uses AI to generate **meaningful feedback and interview insights**
- Built with **Next.js, React, and modern web technologies**
- Designed to make candidate evaluation **faster, more consistent, and structured**

<p align="center">────────────────────────────────────────</p>

<h2>𝑬𝒙𝒑𝒆𝒏𝒔𝒆𝑨𝑰</h2>

An **AI-powered expense tracker** that helps users understand spending patterns and make smarter financial decisions.

**Highlights**

- Automatically categorizes expenses such as food, travel, shopping, and more
- Integrated **Google Gemini API** for intelligent financial insights
- Added interactive charts and visualizations for spending analysis
- Designed to turn raw expense data into actionable information

**Live Demo** → https://expenseai-fmxo.onrender.com/

<p align="center">────────────────────────────────────────</p>

<h2>𝑮𝒓𝒆𝒆𝒏 𝑾𝒐𝒓𝒍𝒅 𝑨𝒄𝒂𝒅𝒆𝒎𝒚</h2>

An interactive **school management website** designed to help students, staff, and administrators access and manage important school information.

**Highlights**

- Implemented **role-based authorization** for secure content management
- Built around real-world requirements and continuous feedback from faculty
...
<i>Always open to discussions on technology, development, and meaningful collaborations.</i>
